          ...
          <div className="membersList">
            {memberList?.map((data, i) => {
              if (
                ...
                if (data.semester === 1) suffix = "st";
                else if (data.semester === 2) suffix = "nd";
                else if (data.semester === 3) suffix = "rd";
                    ...
                    <div className="singleMember" key={i}>
                      <div className="leftSide">
                        ...
                        <div className="member">
                          {data.member !== null ? data.member : "N/A"}
                        </div>
                      </div>
                      <div className="rightSide">
                        <div className="skills">
                          <span>Skill(s)- </span>
                          {data.skills !== null ? data.skills : "N/A"}
                        </div>
                        <div className="interests">
                          <span>Interest(s)- </span>
                          {data.interest !== null ? data.interest : "N/A"}
                        </div>
                        <div className="workshops">
                          <span>Workshop(s) Attended- </span>
                          {data.workshops !== null ? data.workshops : "N/A"}
                        </div>
                      </div>
                    </div>
                  </Zoom>

...
//   };
 ...
 const  OnHandle = (e) => {
    ...
    const firestoremaisave = (e) => {
        ...
        const {  title,duration,totalmarks,testdate,starttime,endtime,positivemarks,negativemarks,questions} = tests;
                    ...
                    <div className="createForm">        
                        <form>
                            ...
                            <div className="inputGroup twoInputs">
                                <div className="input">
                                    <input type="text" name="name" id="name" placeholder="Test Name" onChange={(e) => OnHandle(e)} value={tests.title} required />
                                    <label htmlFor="name">Test Name*</label>
                                </div>
                                <div className="input">
                                    <input type="number" name="duration" id="duration" placeholder="Test Duration(In mins.)" onChange={(e) => OnHandle(e)} value={tests.duration} required />
                                    <label htmlFor="duration">Test Duration(In mins.)*</label>
                                </div>
                            </div>
                            <div className="inputGroup threeInputs">
                                <div className="input">
                                    <input type="date" name="date" id="date" placeholder="Test Date" onChange={(e) => OnHandle(e)} value={tests.testdate} required />
                                    <label htmlFor="date">Test Date*</label>
                                </div>
                                <div className="input">
                                    <input type="time" name="stime" id="stime" placeholder="Starting Time" onChange={(e) => OnHandle(e)} value={tests.starttime} required />
                                    <label htmlFor="stime">Starting Time*</label>
                                </div>
                                <div className="input">
                                    <input type="time" name="etime" id="etime" placeholder="Ending TIme" onChange={(e) => OnHandle(e)} value={tests.endtime} required />
                                    <label htmlFor="etime">Ending Time*</label>
                                </div>
                            </div>
                            <div className="inputGroup threeInputs">
                                <div className="input">
                                    <input type="marks" name="marks" id="marks" placeholder="Total marks" onChange={(e) => OnHandle(e)} value={tests.totalmarks} required />
                                    <label htmlFor="marks">Total Marks*</label>
                                </div>
                                <div className="input">
                                    <input type="number" name="pmarks" id="pmarks" placeholder="Positive Marks" onChange={(e) => OnHandle(e)} value={tests.positivemarks} required />
                                    <label htmlFor="stime">Positive Marks*</label>
                                </div>
                                <div className="input">
                                    <input type="number" name="nmarks" id="nmarks" min="0" placeholder="Negative Marks" onChange={(e) => OnHandle(e)} value={tests.negativemarks} required />

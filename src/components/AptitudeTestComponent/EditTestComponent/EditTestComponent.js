...
//                                 <div className="input">
//                                     <input type="text" name="name" id="name" placeholder="Test Name" onChange={OnChange} value={tests.title} required />
//                                     <label htmlFor="name">Test Name*</label>
//                                 </div>
//                                 <div className="input">
//                                     <input type="number" name="duration" id="duration" placeholder="Test Duration(In mins.)" onChange={OnChange} value={tests.duration} required />
//                                     <label htmlFor="duration">Test Duration(In mins.)*</label>
//                                 </div>
//                             </div>
//                             <div className="inputGroup threeInputs">
//                                 <div className="input">
//                                     <input type="date" name="date" id="date" placeholder="Test Date" onChange={OnChange} value={tests.testdate} required />
//                                     <label htmlFor="date">Test Date*</label>
//                                 </div>
//                                 <div className="input">
//                                     <input type="time" name="stime" id="stime" placeholder="Starting Time" onChange={OnChange} value={tests.starttime} required />
//                                     <label htmlFor="stime">Starting Time*</label>
//                                 </div>
//                                 <div className="input">
//                                     <input type="time" name="etime" id="etime" placeholder="Ending TIme" onChange={OnChange} value={tests.endtime} required />
//                                     <label htmlFor="etime">Ending Time*</label>
//                                 </div>
//                             </div>
//                             <div className="inputGroup threeInputs">
//                                 <div className="input">
//                                     <input type="marks" name="marks" id="marks" placeholder="Total marks" onChange={OnChange} value={tests.totalmarks} required />
//                                     <label htmlFor="marks">Total Marks*</label>
//                                 </div>
//                                 <div className="input">
//                                     <input type="number" name="pmarks" id="pmarks" placeholder="Positive Marks" onChange={OnChange} value={tests.positivemarks} required />
//                                     <label htmlFor="stime">Positive Marks*</label>
//                                 </div>
//                                 <div className="input">
//                                     <input type="number" name="nmarks" id="nmarks" min="0" placeholder="Negative Marks" onChange={OnChange} value={tests.negativemarks} required />

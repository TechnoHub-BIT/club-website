    ...
    <footer>
      <div className="row">
        <div className="col-xl-3 col-md-4 col-sm-6 firstColumn">
          ...
          />
          <p>
            Our goal is to provide a platform to students by students which give
            proper guidance, training and connectivity with school alumni and
            industry experts to students to become Industry ready.
          </p>
        </div>
        <div className="col-xl-3 col-md-4 col-sm-6">
      ...
      <div className="row">
        <div className="col-md-12 socialIcons">
          <div className="socialIcon">
            <a
              href="https://instagram.com/bit.technohub"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <div className="socialIcon">
            <a
              href="https://www.facebook.com/bit.technohub"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <div className="socialIcon">
            <a
              href="https://www.linkedin.com/company/technohubbitd/"
              target="_blank"
              rel="noreferrer"
            >
      ...
      <div className="row developedBy">
        Site Developed by -{" "}
        <a
          href="https://instagram.com/kuldeeppatel0001"
          target="_blank"
          rel="noreferrer"
        >
          Kuldeep Patel
        ...
        ,
        <a
          href="https://instagram.com/aditya0genius"
          target="_blank"
          rel="noreferrer"
        >
          Aditya Deshmukh
        ...
        ,
        <a
          href="https://instagram.com/aaryan610"
          target="_blank"
          rel="noreferrer"
        >
          Aaryan Khandelwal
        ...
        &
        <a
          href="https://instagram.com/bavisettinarayan"
          target="_blank"
          rel="noreferrer"
        >
          Bavisetti Narayan
